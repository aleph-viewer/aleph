...
import { AlAngleSerial, AlEdgeSerial, AlNodeSerial } from "./interfaces";
...
export namespace Components {
  ...
  interface AlControlPanel {
    ...
    stackhelper: AMI.StackHelper | AMI.VolumeRenderingHelper;
    volumeSteps: number;
...
declare global {
  ...
  interface HTMLAlAngleEditorElement
    extends Components.AlAngleEditor,
      HTMLStencilElement {}
  ...
  interface HTMLAlEdgeEditorElement
    extends Components.AlEdgeEditor,
      HTMLStencilElement {}
