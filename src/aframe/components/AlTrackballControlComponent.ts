...
export default AFRAME.registerComponent('al-trackball-control', {
  ...
  mouseDown(_event: MouseEvent) {
    console.log('down-trackball-enabled: ', this.state.controls.enabled);
    this.state.mouseDown = true;
    document.body.style.cursor = 'grabbing';
    console.log('down-trackball-mouseDown, ', this.state.mouseDown);
  },

  mouseMove(_event: MouseEvent) {
    console.log('move-trackball-enabled: ', this.state.controls.enabled);
    console.log('move-trackball-mouseDown, ', this.state.mouseDown);
    if (this.state.mouseDown) {
      console.log('trackball mouse move while down, ', this.state.mouseDown);
      this.el.sceneEl.emit(
