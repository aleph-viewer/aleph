        ...
        return (h("div", { style: {
            ...
            h("ion-button", { style: {
                ...
                h("span", { style: {
                        "font-size": "10px",
                        color: "white"
                    }, slot: "start" }, cameraLabel),
                h("ion-icon", { style: {
                        "min-width": "18px"
                    }, slot: "end", src: cameraIcon, title: cameraLabel })),
            h("ion-button", { style: {
                    width: "80px"
                }, size: "small", onClick: () => {
                    this.recenter.emit();
                ...
                h("span", { style: {
                        "font-size": "10px",
                        color: "white"
                    }, slot: "start" }, this._contentStrings.recenter),
                h("ion-icon", { style: {
                        "min-width": "18px"
                    }, slot: "end", src: RecenterIcon, title: this._contentStrings.recenter })),
            h("ion-button", { style: {
                    width: "80px"
                }, size: "small", onClick: () => {
                ...
                h("span", { style: {
                        "font-size": "10px",
                        color: "white"
                    }, slot: "start" }, this._contentStrings.bounds),
                h("ion-icon", { style: {
                        "min-width": "18px"
    ...
    renderSlicesWindowingControls() {
        return (h("div", null,
            ...
            h("ion-item", { style: {
                ...
                h("ion-range", { slot: "end", min: "0", max: "1", step: ".05", snaps: "true", ticks: "false", value: this.slicesBrightness, onIonChange: e => {
            ...
            h("ion-item", { style: {
                ...
                h("ion-range", { slot: "end", min: "0", max: "1", step: ".05", snaps: "true", ticks: "false", value: this.slicesContrast, onIonChange: e => this._slicesContrast(e.detail.value) }))));
    }
    renderVolumeWindowingControls() {
        return (h("div", null,
            ...
            h("ion-item", { style: {
                ...
                h("span", null, this._contentStrings.brightness),
                h("ion-range", { slot: "end", min: "0", max: "1", step: ".05", snaps: "true", ticks: "false", value: this.volumeBrightness, onIonChange: e => {
            ...
            h("ion-item", { style: {
                ...
                h("span", null, this._contentStrings.contrast),
                h("ion-range", { slot: "end", min: "0", max: "1", step: ".05", snaps: "true", ticks: "false", value: this.volumeContrast, onIonChange: e => this._volumeContrast(e.detail.value) }))));
    }
    renderOptions() {
