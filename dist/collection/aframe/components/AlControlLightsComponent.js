...
export default AFRAME.registerComponent("al-control-lights", {
    ...
    init() {
        ...
        const light1 = new THREE.DirectionalLight(new THREE.Color(Constants.colors.white), Constants.lightIntensity);
        light1.position.copy(new THREE.Vector3(1, 1, 1));
        parent.add(light1);
        const light2 = new THREE.DirectionalLight(new THREE.Color(Constants.colors.white), Constants.lightIntensity);
